...
gulp.task('react', ['less'], function () {
    ...
    return gulp.src(['./src/js/react/orb.react.require.js',
            './src/js/react/orb.react.PivotTable.jsx',
            './src/js/react/orb.react.PivotChart.jsx',
            './src/js/react/orb.react.PivotRow.jsx',
            './src/js/react/orb.react.PivotCell.jsx',
            './src/js/react/orb.react.DragManager.jsx',
            './src/js/react/orb.react.DropIndicator.jsx',
            './src/js/react/orb.react.DropTarget.jsx',
            './src/js/react/orb.react.DropTargetVertical.jsx',
            './src/js/react/orb.react.PivotButton.jsx',
            './src/js/react/orb.react.PivotTable.UpperButtons.jsx',
            './src/js/react/orb.react.PivotTable.ColumnButtons.jsx',
            './src/js/react/orb.react.PivotTable.RowButtons.jsx',
            './src/js/react/orb.react.PivotTable.ColumnHeaders.jsx',
            './src/js/react/orb.react.PivotTable.RowHeaders.jsx',
            './src/js/react/orb.react.PivotTable.DataCells.jsx',
            './src/js/react/orb.react.ScrollBars.jsx',
            './src/js/react/orb.react.Chart.jsx',
            './src/js/react/orb.react.FilterPanel.jsx',
            './src/js/react/orb.react.Dropdown.jsx',
            './src/js/react/orb.react.Grid.jsx',
            './src/js/react/orb.react.Dialog.jsx',
            './src/js/react/orb.react.Toolbar.jsx',
            './src/js/react/orb.react.PivotTable.SizingManager.jsx'])
